...
const translations = {
  de: {
    ...
    proof_3_kicker: 'Deployment', proof_3_title: 'Eigene Infrastruktur', proof_3_desc: 'Mehrere Services hinter nginx, systemd-Units, SSL, Cloudflare und Monitoring — auf VPS und eigener Proxmox-Hardware mit LXC-Containern.',
    ...
    timeline_title: 'Karriere', timeline_1_title: 'AI SaaS Developer', timeline_1_desc: 'ScamGuard, SolarCheck AI, MeisterMeld, DreamDeck — eigenständige Entwicklung von AI-Produkten vom Konzept bis zum Deployment auf eigenem VPS.',
    ...
    projects_kicker: 'Ausgewählte Cases',
    projects_headline: 'Produkte, die mehr zeigen als Code.',
    projects_intro: 'Ich baue AI- und Web-Produkte end-to-end: UX, Frontend, Backend, Datenbank, Deployment und Betrieb. Für Arbeitgeber zählt daran die Production-Erfahrung; für Kunden zählt, dass aus einer Idee ein nutzbares MVP wird.',
    featured_1_type: 'SaaS · Handwerk',
    featured_1_desc: 'Field-service Plattform für Handwerker mit PWA, Auftragslogik, AI-Berichten aus Foto/Sprache und Deployment auf eigenem 1Blue Server.',
    featured_2_type: 'Social Impact · AI',
    featured_2_desc: 'Mehrsprachige Plattform, die Stellenanzeigen in Echtzeit auf Betrugsmuster prüft und Jobsuchende vor Scams schützt.',
    featured_3_type: 'B2B AI · Solar',
    featured_3_desc: 'B2B Lead-Plattform: Dachpotenzial per Adresse, ROI-Logik mit externen APIs und Pay-per-Lead Modell für Installateure.',
    ...
    proj_meisterdesk_role: 'Alleinige Entwicklung: Next.js, Drizzle ORM, PostgreSQL, PWA, AI-Integration, 1Blue-Deployment',
    proj_meisterdesk_proof_1: 'PWA für mobile Teams', proj_meisterdesk_proof_2: 'Drizzle ORM Datenmodell', proj_meisterdesk_proof_3: 'Deployment auf 1Blue Server',
    ...
    github_title: 'GitHub',
    github_intro: 'Öffentlicher Code und Commit-Aktivität — für alle, die vor der Zusammenarbeit gerne selbst reinschauen.',
    github_cta: 'GitHub-Profil ansehen →',
    ...
    work_mode_1_label: 'Für Arbeitgeber',
    work_mode_1_title: 'AI Fullstack Developer für produktionsnahe Teams',
    work_mode_2_label: 'Für Kunden',
    work_mode_2_title: 'AI MVPs, Automationen und Web-Produkte aus einer Hand',
    ...
    cookie_text: 'Diese Website nutzt Google Analytics, um zu verstehen, wie Besucher die Seite nutzen. Deine IP-Adresse wird dabei nur mit deiner Zustimmung an Google übermittelt.',
    cookie_accept: 'Akzeptieren',
    cookie_decline: 'Ablehnen',
    cookie_privacy_link: 'Mehr dazu →',
    ...
    proj_scamguard_title: 'ScamGuard',
    proj_scamguard_desc: 'KI-gestützte Plattform, die Stellenanzeigen und Nachrichten automatisch auf Betrugsmuster analysiert — mehrsprachig, mit eigenen SSR-Routen pro Sprache und lokalem Verlauf im Browser.',
    proj_scamguard_role: 'Alleinige Entwicklung: Next.js App Router, mehrsprachige SSR-Routen, KI-Klassifikation, Deployment auf eigenem VPS',
    proj_scamguard_proof_1: 'Mehrsprachige SSR-Routen ([lang])', proj_scamguard_proof_2: 'KI-Betrugserkennung in Echtzeit', proj_scamguard_proof_3: 'Verlaufs-TTL im localStorage',
  ...
  en: {
    ...
    proof_3_kicker: 'Deployment', proof_3_title: 'Self-hosted infrastructure', proof_3_desc: 'Multiple services behind nginx, systemd units, SSL, Cloudflare and monitoring — on VPS and my own Proxmox hardware with LXC containers.',
    ...
    timeline_title: 'Career', timeline_1_title: 'AI SaaS Developer', timeline_1_desc: 'ScamGuard, SolarCheck AI, MeisterMeld, DreamDeck — solo-built AI products from concept to production deployment on own VPS.',
    ...
    projects_kicker: 'Selected cases',
    projects_headline: 'Products that show more than code.',
    projects_intro: 'I build AI and web products end to end: UX, frontend, backend, database, deployment and operations. For employers this shows production experience; for clients it means an idea can become a usable MVP.',
    featured_1_type: 'SaaS · Trades',
    featured_1_desc: 'Field-service platform for craftsmen with PWA, job workflows, AI reports from photo/voice input and deployment on my own 1Blue server.',
    featured_2_type: 'Social Impact · AI',
    featured_2_desc: 'Multilingual platform that checks job listings in real time for scam patterns and protects job seekers from fraud.',
    featured_3_type: 'B2B AI · Solar',
    featured_3_desc: 'B2B lead platform: roof potential by address, ROI logic with external APIs and a pay-per-lead model for installers.',
    ...
    proj_meisterdesk_role: 'Solo development: Next.js, Drizzle ORM, PostgreSQL, PWA, AI integration, 1Blue deployment',
    proj_meisterdesk_proof_1: 'PWA for mobile teams', proj_meisterdesk_proof_2: 'Drizzle ORM data model', proj_meisterdesk_proof_3: 'Deployment on 1Blue server',
    ...
    github_title: 'GitHub',
    github_intro: 'Public code and commit activity — for anyone who likes to check things out before working together.',
    ...
    work_mode_1_label: 'For employers',
    work_mode_1_title: 'AI Fullstack Developer for production-minded teams',
    work_mode_2_label: 'For clients',
    work_mode_2_title: 'AI MVPs, automations and web products end to end',
    contact_phone: 'Phone',
    ...
    cookie_text: 'This site uses Google Analytics to understand how visitors use it. Your IP address is only shared with Google if you consent.',
    ...
    proj_scamguard_title: 'ScamGuard',
    proj_scamguard_desc: 'AI-powered platform that automatically analyzes job listings and messages for scam patterns — multilingual, with dedicated SSR routes per language and local browser history.',
    proj_scamguard_role: 'Solo development: Next.js App Router, multilingual SSR routes, AI classification, deployment on own VPS',
    proj_scamguard_proof_1: 'Multilingual SSR routes ([lang])', proj_scamguard_proof_2: 'Real-time AI scam detection', proj_scamguard_proof_3: 'History TTL in localStorage',
  ...
  ru: {
    ...
    proof_3_kicker: 'Deployment', proof_3_title: 'Своя инфраструктура', proof_3_desc: 'Несколько сервисов за nginx, systemd-units, SSL, Cloudflare и мониторинг — на VPS и собственном железе на Proxmox с LXC-контейнерами.',
    ...
    timeline_title: 'Карьера', timeline_1_title: 'AI SaaS разработчик', timeline_1_desc: 'ScamGuard, SolarCheck AI, MeisterMeld, DreamDeck — самостоятельная разработка AI-продуктов от концепции до деплоя на собственном VPS.',
    ...
    projects_kicker: 'Ключевые кейсы',
    projects_headline: 'Продукты, которые показывают больше, чем код.',
    projects_intro: 'Я создаю AI- и web-продукты end-to-end: UX, frontend, backend, базу данных, деплой и эксплуатацию. Для работодателя это production-опыт; для клиента — путь от идеи до рабочего MVP.',
    featured_1_type: 'SaaS · Ремесло',
    featured_1_desc: 'Field-service платформа для мастеров: PWA, логика заказов, AI-отчёты из фото/голоса и деплой на собственном сервере 1Blue.',
    featured_2_type: 'Social Impact · AI',
    featured_2_desc: 'Мультиязычная платформа, которая в реальном времени проверяет вакансии на признаки мошенничества и защищает соискателей от скама.',
    featured_3_type: 'B2B AI · Solar',
    featured_3_desc: 'B2B лид-платформа: потенциал крыши по адресу, ROI-логика с внешними API и pay-per-lead модель для монтажников.',
    ...
    proj_meisterdesk_role: 'Самостоятельная разработка: Next.js, Drizzle ORM, PostgreSQL, PWA, AI-интеграция, деплой на 1Blue',
    proj_meisterdesk_proof_1: 'PWA для мобильных команд', proj_meisterdesk_proof_2: 'Модель данных на Drizzle ORM', proj_meisterdesk_proof_3: 'Деплой на сервере 1Blue',
    ...
    github_title: 'GitHub',
    github_intro: 'Публичный код и активность коммитов — для тех, кто любит сам всё посмотреть перед началом сотрудничества.',
    github_cta: 'Смотреть профиль на GitHub →',
    ...
    work_mode_1_label: 'Для работодателей',
    work_mode_1_title: 'AI Fullstack Developer для команд с production-фокусом',
    work_mode_2_label: 'Для клиентов',
    work_mode_2_title: 'AI MVP, автоматизации и web-продукты из одних рук',
    ...
    cookie_text: 'Этот сайт использует Google Analytics, чтобы понимать, как посетители им пользуются. IP-адрес передаётся Google только с вашего согласия.',
    cookie_accept: 'Принять',
    cookie_decline: 'Отклонить',
    cookie_privacy_link: 'Подробнее →',
    footer_impressum: 'Импрессум',
    footer_datenschutz: 'Конфиденциальность',
    currently_label: 'Сейчас строю:',
    chat_subtitle: 'AI-ассистент',
    ...
    proj_scamguard_title: 'ScamGuard',
    proj_scamguard_desc: 'ИИ-платформа, автоматически анализирующая объявления о работе и сообщения на признаки мошенничества — мультиязычная, с собственными SSR-маршрутами для каждого языка и историей в браузере.',
    proj_scamguard_role: 'Самостоятельная разработка: Next.js App Router, мультиязычные SSR-маршруты, ИИ-классификация, деплой на собственном VPS',
    proj_scamguard_proof_1: 'Мультиязычные SSR-маршруты ([lang])', proj_scamguard_proof_2: 'ИИ-детекция скама в реальном времени', proj_scamguard_proof_3: 'TTL истории в localStorage',
  ...
  ua: {
    ...
    proof_3_kicker: 'Deployment', proof_3_title: 'Власна інфраструктура', proof_3_desc: 'Кілька сервісів за nginx, systemd-units, SSL, Cloudflare та моніторинг — на VPS і власному залізі на Proxmox з LXC-контейнерами.',
    ...
    timeline_title: "Кар'єра", timeline_1_title: 'AI SaaS розробник', timeline_1_desc: 'ScamGuard, SolarCheck AI, MeisterMeld, DreamDeck — самостійна розробка AI-продуктів від концепції до деплою на власному VPS.',
    ...
    projects_kicker: 'Ключові кейси',
    projects_headline: 'Продукти, що показують більше, ніж код.',
    projects_intro: 'Я створюю AI- та web-продукти end-to-end: UX, frontend, backend, базу даних, деплой та експлуатацію. Для роботодавця це production-досвід; для клієнта — шлях від ідеї до робочого MVP.',
    featured_1_type: 'SaaS · Ремесло',
    featured_1_desc: 'Field-service платформа для майстрів: PWA, логіка замовлень, AI-звіти з фото/голосу та деплой на власному сервері 1Blue.',
    featured_2_type: 'Social Impact · AI',
    featured_2_desc: 'Багатомовна платформа, яка в реальному часі перевіряє вакансії на ознаки шахрайства та захищає шукачів роботи від скаму.',
    featured_3_type: 'B2B AI · Solar',
    featured_3_desc: 'B2B лід-платформа: потенціал даху за адресою, ROI-логіка із зовнішніми API та pay-per-lead модель для монтажників.',
    ...
    proj_meisterdesk_role: 'Самостійна розробка: Next.js, Drizzle ORM, PostgreSQL, PWA, AI-інтеграція, деплой на 1Blue',
    proj_meisterdesk_proof_1: 'PWA для мобільних команд', proj_meisterdesk_proof_2: 'Модель даних на Drizzle ORM', proj_meisterdesk_proof_3: 'Деплой на сервері 1Blue',
    ...
    github_title: 'GitHub',
    github_intro: 'Публічний код і активність комітів — для тих, хто любить сам усе подивитись перед співпрацею.',
    github_cta: 'Переглянути профіль на GitHub →',
    ...
    work_mode_1_label: 'Для роботодавців',
    work_mode_1_title: 'AI Fullstack Developer для команд з production-фокусом',
    work_mode_2_label: 'Для клієнтів',
    work_mode_2_title: 'AI MVP, автоматизації та web-продукти з одних рук',
    contact_phone: 'Телефон',
    ...
    footer_infra: 'Portfolio на Vercel · API на VPS · AI-proxy на Cloudflare',
    footer_cookie_settings: 'Налаштування cookie',
    cookie_text: 'Цей сайт використовує Google Analytics, щоб розуміти, як відвідувачі ним користуються. IP-адреса передається Google лише за вашої згоди.',
    cookie_accept: 'Прийняти',
    cookie_decline: 'Відхилити',
    cookie_privacy_link: 'Детальніше →',
    footer_impressum: 'Імпресум',
    footer_datenschutz: 'Конфіденційність',
    currently_label: 'Зараз будую:',
    chat_subtitle: 'AI-асистент',
    ...
    proj_scamguard_title: 'ScamGuard',
    proj_scamguard_desc: 'AI-платформа, що автоматично аналізує оголошення про роботу та повідомлення на ознаки шахрайства — багатомовна, з власними SSR-маршрутами для кожної мови та історією в браузері.',
    proj_scamguard_role: 'Самостійна розробка: Next.js App Router, багатомовні SSR-маршрути, AI-класифікація, деплой на власному VPS',
    proj_scamguard_proof_1: 'Багатомовні SSR-маршрути ([lang])', proj_scamguard_proof_2: 'AI-детекція скаму в реальному часі', proj_scamguard_proof_3: 'TTL історії в localStorage',
