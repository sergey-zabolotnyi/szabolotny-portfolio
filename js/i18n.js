...
const translations = {
  de: {
    ...
    timeline_title: 'Karriere', timeline_1_title: 'AI SaaS Developer', timeline_1_desc: 'SolarCheck AI, MeisterMeld, DreamDeck — eigenständige Entwicklung von AI-Produkten vom Konzept bis zum Deployment auf eigenem VPS.',
    ...
    featured_2_type: 'AI MVP · Renovierung',
    featured_2_desc: 'AI analysiert Raumfotos und erstellt strukturierte Kostenschätzungen mit Arbeiten, Materialien, Preisen und Designvorschlägen.',
  ...
  en: {
    ...
    timeline_title: 'Career', timeline_1_title: 'AI SaaS Developer', timeline_1_desc: 'SolarCheck AI, MeisterMeld, DreamDeck — solo-built AI products from concept to production deployment on own VPS.',
    ...
    featured_2_type: 'AI MVP · Renovation',
    featured_2_desc: 'AI analyzes room photos and generates structured cost estimates with tasks, materials, prices and design suggestions.',
    featured_3_type: 'B2B AI · Solar',
  ...
  ru: {
    ...
    timeline_title: 'Карьера', timeline_1_title: 'AI SaaS разработчик', timeline_1_desc: 'SolarCheck AI, MeisterMeld, DreamDeck — самостоятельная разработка AI-продуктов от концепции до деплоя на собственном VPS.',
    ...
    featured_2_type: 'AI MVP · Ремонт',
    featured_2_desc: 'AI анализирует фото помещений и генерирует структурированные сметы: работы, материалы, цены и дизайн-предложения.',
    featured_3_type: 'B2B AI · Solar',
  ...
  ua: {
    ...
    timeline_title: "Кар'єра", timeline_1_title: 'AI SaaS розробник', timeline_1_desc: 'SolarCheck AI, MeisterMeld, DreamDeck — самостійна розробка AI-продуктів від концепції до деплою на власному VPS.',
    ...
    featured_2_type: 'AI MVP · Ремонт',
    featured_2_desc: 'AI аналізує фото приміщень і генерує структуровані кошториси: роботи, матеріали, ціни та дизайн-пропозиції.',
    featured_3_type: 'B2B AI · Solar',
